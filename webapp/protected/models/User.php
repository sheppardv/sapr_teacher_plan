...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('created_at, changed_at, last_visited_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, firstName, lastName, fatherName, password, status, type, created_at, changed_at, last_visited_at', 'safe', 'on'=>'search'),
		);
	}
